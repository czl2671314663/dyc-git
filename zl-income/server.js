  ...
  try {
    ...
    const [rows] = query(`
      SELECT DEPT_CODE, DEPT_NAME,
        ...
        COALESCE(SUM(CASE WHEN YB_FLG_CODE != '01' THEN NUM_DEPT ELSE 0 END), 0) AS yb_visits,
        COALESCE(SUM(CASE WHEN YB_FLG_CODE = '01' THEN NUM_DEPT ELSE 0 END), 0) AS self_pay_visits
      FROM ads_dept_income ${clause}
      GROUP BY DEPT_CODE, DEPT_NAME
